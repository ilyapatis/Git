...
3. Создайте авторизированный токен.
...
## Комментарий по .gitignore

Будут проигнорированы:

1. папка с кэшем и рабочими данными .terraform/;
2. файлы состояния инфраструктуры, которые имеют расширение .tfstate или символы в имени tfstate.* с любым расширением;
3. конкретный файл с именем crash.log или файлы, имеющие символы в имени crash.*.log;
4. файлы с переменными с расширением .tfvars или tfvars.json;
5. файлы override.tf, override.tf.json, также файлы оканчивающиеся на _override.tf или _override.tf.json;
6. временный файл блокировки состояния .terraform.tfstate.lock.info;
7. файлы конфигурации CLI Terraform .terraformrc и terraform.rc.
